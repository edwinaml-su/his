          ...
          {filteredItems.map((item) => {
            ...
            return (
              <SidebarMenuItem key={item.href}>
                  ...
                  tooltip={{
                    children: (
                      <>
                        ...
                        <div className="mt-0.5 text-xs leading-snug">{item.description}</div>
                      </>
                    ),
                    className: "max-w-xs",
                  }}
                ...
                >
                  <Link href={item.href} aria-label={`${item.label} — ${item.description}`}>
...
export function AppSidebar({
  ...
  return (
    <Sidebar collapsible="icon">
      {/* Logo / branding */}
      <SidebarHeader className={cn("border-b border-sidebar-border", state === "collapsed" ? "items-center" : "")}>
