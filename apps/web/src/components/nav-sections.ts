...
export const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/honorarios", label: "Honorarios Médicos", icon: Coins,
        requiredRoles: ["ADMIN", "DIR", "ANALISTA_HONORARIOS", "GERENTE_FINANCIERO", "MEDICO_AFILIADO"],
        description: "CC-0036 Ola 5 — convenios y reglas de honorario, producción atribuida y liquidación por médico afiliado (REQ-HIS-AFIL-001)." },
      ...
      { href: "/turnos", label: "Turnos", icon: Calendar,
        requiredRoles: ["JEFE_MEDICO_SEDE", "ADMIN", "DIR"],
        description: "CC-0036 — rostering 24/7: plantillas de turno, programación mensual y médico/enfermero de guardia por sede (REQ-HIS-AFIL-001)." },
      ...
      { href: "/calculadoras", label: "Calculadoras clínicas", icon: Calculator,
        requiredRoles: ["ADMIN", "DIR", "PHARM"],
        description: "Catálogo de fórmulas y scores clínicos: versionado, activación por país, visibilidad y publicación." },
