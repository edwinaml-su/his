...
| P0-2 | RLS no homogéneo entre routers | **R02** (Crítica, *parcial*) | Crítica | **57 de 153 routers** tocan `organizationId` sin `withTenantContext`; solo 76 usan contexto RLS | 0 routers con PHI fuera de contexto RLS + test de aislamiento por router |
