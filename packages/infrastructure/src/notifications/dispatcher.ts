...
export async function dispatchDomainEvent(
  ...
  // automáticamente.
  //
  // Riesgo de deadlock 40P01 (incidente 2026-09-15): bajo ráfagas de
  // despachos concurrentes, las tx cruzan locks en la cadena de hash de
  // auditoría (sql/05/43). La Edge Function (ruta de runtime real del poller
